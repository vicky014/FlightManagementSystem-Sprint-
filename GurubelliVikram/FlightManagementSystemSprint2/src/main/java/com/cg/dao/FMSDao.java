	...
	/*if admin wants to view all Flight details
			...
			public Flight viewFlight(String flightNumber)
			{
				...
				Optional <Flight> optional=list.stream().
						filter(f1->f1.getFlightNumber().equals(flightNumber)).findFirst();
...
//			/this function is used*/
		...
		//Schedule
			...
			public Schedule viewSchedule(String scheduleId) {
				...
				Optional <Schedule> optional=list.stream().
						filter(s1->s1.getScheduleId().equalsIgnoreCase(scheduleId)).findFirst();
				if(optional.isPresent())
				{
		...
		//ScheduledFlight
			...
			@Override
			public ScheduledFlight viewScheduledFlight(String flightNumber)
			{
				...
				Optional <ScheduledFlight> optional=list.stream().
						filter(sf1->sf1.getFlight().getFlightNumber().equalsIgnoreCase(flightNumber)).findFirst();
				if(optional.isPresent())
				{
			 ...
			 * this function is used*/
			@Override
			public String deleteScheduledFlight(String flightNumber) {
